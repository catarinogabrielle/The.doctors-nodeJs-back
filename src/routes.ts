...
import { ListPublicCoursesByTeacherController } from './controllers/mycourse/ListPublicCoursesByTeacherController'
...
router.get('/myclasses/public/teacher/:teacher_id', new ListPublicCoursesByTeacherController().handle)
